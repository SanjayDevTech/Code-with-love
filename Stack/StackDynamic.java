/**
* In science of science, a pile is an ordered set of non-qualifying items that can be
* inserted and from which they can be disposed of at a single end - the top of the pile.
* Due to its form of operation, this data structure also has an alternative name - LIFO (Last-In, Fist-Out).
